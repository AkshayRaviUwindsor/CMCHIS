//
//  DrAgarwalsEyeHospitalDharmapuriDetailedSViewController.swift
...
class DrAgarwalsEyeHospitalDharmapuriDetailedSViewController: UIViewController {
    ...
    @IBAction func Appointment(_ sender: Any) {
        let url: NSURL = URL(string: "tel://+914342269666")! as NSURL
        UIApplication.shared.open(url as URL, options: [:], completionHandler: nil)
    ...
    @IBAction func Location(_ sender: Any) {
        ...
        let latitude: CLLocationDegrees = 12.125628
        let longitude: CLLocationDegrees = 78.158265
