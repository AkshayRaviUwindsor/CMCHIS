//
//  DrAgarwalsEyeHospitalErodeDetailedSViewController.swift
...
class DrAgarwalsEyeHospitalErodeDetailedSViewController: UIViewController {
    ...
    @IBAction func Appointment(_ sender: Any) {
        let url: NSURL = URL(string: "tel://+914242223666")! as NSURL
        UIApplication.shared.open(url as URL, options: [:], completionHandler: nil)
    }
    ...
    @IBAction func Location(_ sender: Any) {
        let latitude: CLLocationDegrees = 11.331242
        let longitude: CLLocationDegrees = 77.699496
