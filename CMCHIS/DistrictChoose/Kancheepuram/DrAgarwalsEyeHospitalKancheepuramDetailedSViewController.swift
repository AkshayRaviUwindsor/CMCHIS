//
//  DrAgarwalsEyeHospitalKancheepuramDetailedSViewController.swift
...
class DrAgarwalsEyeHospitalKancheepuramDetailedSViewController: UIViewController {
    ...
    @IBAction func Appointment(_ sender: Any) {
        ...
        let url: NSURL = URL(string: "tel://+914427232525")! as NSURL
        UIApplication.shared.open(url as URL, options: [:], completionHandler: nil)
    ...
    @IBAction func Location(_ sender: Any) {
        ...
        let latitude: CLLocationDegrees = 12.860901
        let longitude: CLLocationDegrees = 79.702039
