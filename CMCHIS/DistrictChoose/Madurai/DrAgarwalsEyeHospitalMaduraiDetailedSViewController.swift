//
//  DrAgarwalsEyeHospitalMaduraiDetailedSViewController.swift
...
class DrAgarwalsEyeHospitalMaduraiDetailedSViewController: UIViewController {
    ...
    @IBAction func Appointment(_ sender: Any) {
        ...
        let url: NSURL = URL(string: "tel://+914522301333")! as NSURL
        UIApplication.shared.open(url as URL, options: [:], completionHandler: nil)
    ...
    @IBAction func Location(_ sender: Any) {
        ...
        let latitude: CLLocationDegrees = 9.935797
        let longitude: CLLocationDegrees =  78.101611
