//
//  TankerFoundationDetailedSViewController.swift
...
class TankerFoundationDetailedSViewController: UIViewController {
    ...
    @IBAction func Appointment(_ sender: Any) {
        ...
        let url: NSURL = URL(string: "tel://+914522525690")! as NSURL
        UIApplication.shared.open(url as URL, options: [:], completionHandler: nil)
    ...
    @IBAction func Location(_ sender: Any) {
        ...
        let latitude: CLLocationDegrees = 9.939413
        let longitude: CLLocationDegrees =  78.135111
        ...
        mapItem.name = "Tanker Foundation"
