//
//  DrAgarwalsEyeHospitalThanjavurDetailedSViewController.swift
...
class DrAgarwalsEyeHospitalThanjavurDetailedSViewController: UIViewController {
    ...
    @IBAction func Appointment(_ sender: Any) {
        ...
        let url: NSURL = URL(string: "tel://+919444449917")! as NSURL
        UIApplication.shared.open(url as URL, options: [:], completionHandler: nil)
    ...
    @IBAction func Location(_ sender: Any) {
        ...
        let latitude: CLLocationDegrees = 10.969595
        let longitude: CLLocationDegrees = 79.397311
